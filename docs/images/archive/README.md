...
### Web GUI — Live Debate Streaming

![Web GUI Showcase](docs/images/web_run_main.png)

### Terminal CLI — Color-Coded Live Output

![Terminal CLI Showcase](docs/images/terminal_run_main.png)
